...
<br />
<img src="/action-node-test.gif" alt="Outerbridge Action Node" height="auto" width='100%'></img>


## Trigger Node

Trigger node is a node that listens to event via [NodeJS Event Emitter](https://nodejs.dev/learn/the-nodejs-event-emitter).
...
<br />
<img src="/trigger-node-test.gif" alt="Outerbridge Trigger Node" height="auto" width='100%'></img>
...
<br />
<img src="/webhook-node-test.gif" alt="Outerbridge Webhook Node" height="auto" width='100%'></img>
